...
public class Shop {
	...
	def static void addToCart(String productName,String urlProduct){
		...
		WebUI.waitForElementPresent(findTestObject('Miscellinious/Pages/Shop page/btnAddToCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('Miscellinious/Pages/Shop page/btnAddToCart'))

		WebUI.waitForElementPresent(findTestObject('Miscellinious/Pages/Shop page/lnkViewCart'), GlobalVariable.waitPresentTimeout)
		WebUI.click(findTestObject('Miscellinious/Pages/Shop page/lnkViewCart'))

		WebUI.verifyElementPresent(findTestObject('Miscellinious/Pages/Shop page/btnProceed'), GlobalVariable.waitPresentTimeout)
	}
	...
	def static void applyCouponAndAddToCart(String productName,String urlProduct,String coupon){
		...
		WebUI.setText(findTestObject('Miscellinious/Pages/Shop page/txtCoupon'), coupon)
		WebUI.click(findTestObject('Miscellinious/Pages/Shop page/btnApply'))
	}
